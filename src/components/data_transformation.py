...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            numerical_features = ['balance', 'duration', 'Count_Txn', 'Annual_Income',"duration","campaign","age"]
            categorical_features = ['job', 'marital', 'education',"loan" ,'poutcome',"housing","Gender"]
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            target_column_name="Term Deposit"
